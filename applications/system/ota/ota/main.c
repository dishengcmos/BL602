...
#define ROUTER_SSID "Litebee_Fm"
#define ROUTER_PWD "test1234"

//#define url "https://chencong--test.oss-cn-beijing.aliyuncs.com/test.bin"
//#define url "https://mkf-resource.oss-cn-shenzhen.aliyuncs.com/softwareDownload/test.bin"
#define url "http://192.168.0.145:5566/test.bin"
